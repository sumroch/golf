...
class TournamentFactory
{
    ...
    public static function dashboard($data)
    {
        return [
            ...
            'morning_hour' => Carbon::createFromFormat('H:i:s', $data->morning ?? '00:00:00')->format('H'),
            'morning_minute' => Carbon::createFromFormat('H:i:s', $data->morning ?? '00:00:00')->format('i'),
            'afternoon_hour' => Carbon::createFromFormat('H:i:s', $data->afternoon ?? '00:00:00')->format('H'),
            'afternoon_minute' => Carbon::createFromFormat('H:i:s', $data->afternoon ?? '00:00:00')->format('i'),
